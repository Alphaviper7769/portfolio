...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Aayush Raturi",
    description: `Full-stack website developer and Machine Learning enthusiast.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.alphaviper.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.alphaviper.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Aayush" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Aayush" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Aayush Raturi</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Alphaviper. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
